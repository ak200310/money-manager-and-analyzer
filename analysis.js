document.addEventListener('DOMContentLoaded', () => {
    ...
    if (Object.keys(savings).length === 0) {
        alert("No Expense data available to analyze.");
        return;
    }
    ...
    const barCtx = document.getElementById('expenses-bar-chart').getContext('2d');
    const lineCtx = document.getElementById('expenses-line-chart').getContext('2d');
    ...
    document.getElementById('download-pdf').addEventListener('click', () => {
        ...
        doc.text('My  Analysis', 10, 10);

        const barChartCanvas = document.getElementById('expenses-bar-chart');
        ...
        const lineChartCanvas = document.getElementById('expenses-line-chart');
        ...
        html2canvas(tableElement).then(canvas => {
            ...
            doc.save('my_expense_analysis.pdf');
        });
    });
